---
title: "Data-Driven Decision Making in Animal Sciences"
...
|------------|------------|------------|------------|------------|------------|
| am |  |  |  |  | Every other week - project management meeting |
| pm | Lecture |  | Weekly coding lab | Project (incl. 3 field trips or meetings with farmer) |  |
|  |  |  |  |  |  |
...
One the things you will definitely learn in this course will involve writing code, and coding is a skill that is best learned by doing. Therefore, you will need to finish a weekly coding assignment. Every week a new assignment will be opened for each of you on the online coding platform [Dodona](https://www.dodona.be/). There is a strict deadline at Friday evening 17:00 to finish the assignment, individually. The percentage of successfully finished coding assignments at the end of the course is part of your individual grading (see below).
...
We will hold project meetings every other week, during which we will discuss the groups overall progress for the project, address any challenges, and provide guidance. These meetings are an opportunity for you to share updates, receive feedback, and collaborate with your peers and instructors. Your active participation is crucial to ensure that you stay on track and achieve the project goals.
...
|--------------------------|----------------|------------------------------|
| Use of appropriate naming conventions used throughout project (subgroups) | 20% | Failure to use any naming convention in the project will result in failing the entire group project. |
| FAIR principle compliance in reporting, documentation of data and coding through notebooks | 20% | Failure to implement the FAIR principles will result in failing the entire group project. |
| Project presentation | 30% | We will discuss within the group how to assess each individuals contribution (as some people maybe will not be presenting). |
...
## **Responsible Use of Generative Tools in Our Class**
